...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        <!-- Back Button -->
        <a href="{{ route('productos.index') }}" class="text-slate-600 hover:text-slate-800 font-semibold mb-6 inline-block">
            ← Volver al listado
        </a>
            ...
            <form method="POST" action="{{ route('productos.update', $producto->id) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('sku') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('category') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        name="description"
                        rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('description') border-red-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            step="0.01"
                            min="0"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('price') border-red-500 @enderror"
                            placeholder="0.00"
                            required
                        >
                        @error('price')
